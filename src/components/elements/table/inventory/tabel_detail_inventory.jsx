        ...
        <table className="table">
          <tbody className="text-left text-[12px]">
            <tr className=" flex flex-row  m-0 border-none">
              ...
              <td className="w-[250px] ">: {inventoryData.kodeAsset}</td>
            </tr>
            ...
            <tr className="flex flex-row border-none">
              ...
              <td className="w-[250px]">: {inventoryData.tanggalPembelian}</td>
            </tr>
            <tr className="flex flex-row border-none">
            ...
            <tr className="flex flex-row border-none">
              ...
              <td className="w-[250px]">: {inventoryData.karyawanInduk}</td>
            </tr>
            <tr className="flex flex-row border-none">
            ...
            <tr className="flex flex-row border-none">
              ...
              <td className="w-[250px]">: {inventoryData.ruanganNama}</td>
            </tr>
          </tbody>
        </table>
      </div>
        ...
        <table className="table">
          <tbody className="text-left text-[12px]">
            ...
            <tr className="flex flex-row border-none">
              ...
              <td className="w-[250px]">: Rp. {inventoryData.nilaiResidu}</td>
            </tr>
            <tr className="flex flex-row border-none">
              <th className="text-gray-600 w-40">Tahun 1</th>
              <td className="w-[250px]">: Rp. {inventoryData.tahun1}</td>
            </tr>
            <tr className="flex flex-row border-none">
              <th className="text-gray-600 w-40">Tahun 2</th>
              <td className="w-[250px]">: Rp. {inventoryData.tahun2}</td>
            </tr>
            <tr className="flex flex-row border-none">
              <th className="text-gray-600 w-40">Tahun 3</th>
              <td className="w-[250px]">: Rp. {inventoryData.tahun3}</td>
            </tr>
            <tr className="flex flex-row border-none">
              <th className="text-gray-600 w-40">Tahun 4</th>
              <td className="w-[250px]">: Rp. {inventoryData.tahun4}</td>
            </tr>
            <tr className="flex flex-row border-none">
              <th className="text-gray-600 w-40">Depresiasi</th>
              <td className="w-[250px]">: Rp. {inventoryData.depresiasi}</td>
            </tr>
            <tr className="flex flex-row border-none">
              <th className="text-gray-600 w-40">Kategori</th>
              <td className="w-[250px]">: {inventoryData.kategoriNama}</td>
            </tr>
            <tr className="flex flex-row border-none">
